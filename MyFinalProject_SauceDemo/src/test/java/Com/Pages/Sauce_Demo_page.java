...
{ 
	...
	By Appium=By.linkText("Appium");
	By Platform_configurator=By.className("button is-rounded is-primary");
	By webdriver_W3c=By.linkText("WebDriver (W3C)");
...
// Launch and maximize chrome browser    
public void url()
{
...
public void Invalidlogin() throws IOException, InterruptedException
{
	...
	Thread.sleep(2000);
    driver.findElement(password).sendKeys("Riyaz7**");
    Thread.sleep(2000);
    driver.findElement(login).click();
}
...
//checking technology alliance in company field for valid details
